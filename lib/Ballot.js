const index = require('../');
/** @module approval-voting/lib/Ballot */
/**
...
class Ballot {
  ...
  constructor(...questions) {
    const questionsHash = questions.map((q)=>q.getHash());
    this.data = {
      questionsHash,//for now may add more later
    }
    Object.freeze(this);
    Object.freeze(this.data);
  }
  getHash(){
    return index.ext.ObjectHash(this.data,{algorithim:index.cfg.algorithim})
  }
  /**
  ...
  cast() {
    ...
    //this.data.questionsHash = this.data
    Object.freeze(this.data);
  }
